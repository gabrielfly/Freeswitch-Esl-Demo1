package com.guopeng.freeswitch.esl.inbound.handler;
...
import com.guopeng.freeswitch.esl.helper.EslHelper;
...
import com.guopeng.freeswitch.esl.util.RemotingUtil;
...
public class InboundChannelHandler extends SimpleChannelInboundHandler<EslMessage> {
     ...
     *
     * @param listener              a {@link com.guopeng.freeswitch.esl.inbound.listener.ChannelEventListener} object.
     ...
     * queue and blocks waiting for another IO thread to process an incoming {@link com.guopeng.freeswitch.esl.transport.message.EslMessage} and
     * attach it to the callback.
     *
     * @param command single string to send
     * @return the {@link com.guopeng.freeswitch.esl.transport.message.EslMessage} attached to this command's callback
     */
