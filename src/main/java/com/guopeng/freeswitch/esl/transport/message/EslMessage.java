 ...
 * <p>
 * Header lines are parsed and cached in a map keyed by the {@link com.guopeng.freeswitch.esl.transport.message.EslHeaders.Name} enum.  A message
...
public class EslMessage {
    ...
    /**
     * All the received message headers in a map keyed by {@link com.guopeng.freeswitch.esl.transport.message.EslHeaders.Name}. The string mapped value
     ...
     * Convenience method
     *
     * @param headerName as a {@link com.guopeng.freeswitch.esl.transport.message.EslHeaders.Name}
